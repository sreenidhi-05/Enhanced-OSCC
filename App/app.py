...
home_image_path = "architecture.png"
...
Images are split into train, validation, and test sets. The model is trained, evaluated, and deployed via tools like Gradio. To know more about the model, visit the *Model* Tab.
""")
        ...
        with gr.Tab("Prediction"):
            ...
            submit_btn.click(fn=predict_and_show, inputs=[image_input], outputs=[preprocessed_output, prediction_output, blur_overlay], queue=True)
            image_input.change(fn=reset_outputs, inputs=[], outputs=[preprocessed_output, prediction_output, blur_overlay])
